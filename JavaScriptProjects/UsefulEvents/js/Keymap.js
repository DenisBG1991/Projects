 ...
 * собой отображение идетнификаторов комбинации клавиш (определяемых ниже)
 * в функции-обработчике. Объект Keymap можно установить в HTML-элемент
 * для обработки собятий keydown. Когда возникает это событие, объект Keymap
 * использует свою карту привязок для вызова соответствующего обработчика.
 *
 * При создании объекта Keymap конструктуру можно передать JavaScript-объект,
 * представляющий начальную карту привязок. Имена свойств этого объекта должны
 * соответствовать индификаторам клавиш, а значениями должны быть функции-обработчики.
 ...
 * удалить привязку, передав индикатор клавиши методу unbind().
 *
 ...
 * обработчик события keydown. Когда этот обработчик будет вызван, он определит
 ...
 * клавиш-модификаторов. Именем клавиши является основном текст, изображаемый
 ...
 *
 * Идентификатор клавиши может также вкючать имена клавиш-модификаторов.
 ...
 * или знаками +. Например: "SHIFT+A", "Atl_F2", "meta-v" и "ctrl alt left".
 ...
 * в зависимости от того, как был установлен объект Keymap, и им передаются
 * два аргумента:
 *      1) объект события keydown
 *      2) идентификатор нажатой клавиши
 * Значение, возвращаемое функцией, становится возвращаемым значением
 * обработчика собфтия keydown. Если функция-обработчик вернет false,
 * объект Keymap прервет всплятие собятия и предотвратит выполнение любых
 ...
 * от особенностей браузера, ОС и региональных настроек. С успехом можно использовать
 * функциональные клавиши и функциональные клавиши с модификаторами, а также
 * алфавитно-цифровые клавиши без модификаторов. Комбинации алфавитно-цифровых клавиш
 * с модификаторами Ctrl и Alt менее надежны.
 *
 * Поддерживается большинство знаков препинания, кроме дефиса, для ввода которых
 * не требуется удерживать клавишу Shift ( '=[];',./\) на клавиатурах со стандартной
 * раскладкой US. Но они плохо совместимы с другими раскладками клавиатур, и их
...
// Связать указанные идентификаторы клавиш с указанной функцией-обработчиком
...
Keymap.prototype.dispatch = function (event, element) {
    // Изначально нет ни имен клавиш-модификаторов, ни имен клавиш
    var modifiers = "",
        keyname = null;
    ...
    // Имя клавиши легко получить, если реализовано свойства key,
    // определяемое стандартом DOM Level 3.
    if (event.key) keyname = event.key;
    // Для получения имен функциональных клавиш Safari и Chrome можно
...
Keymap.normalize = function (keyid) {
    ...
    keyname = Keymap.aliases[keyname] || keyname;   // Проверить на псевдоним
    words.sort();
    words.push(keyname);
...
Keymap.aliases = {          // Отображение привычных псевдонимов клавиш и их
    "escape": "esc",        // "официальные" имена, используемые в DOM Level 3,
    "delete": "del",        // и отображение колов клавиш в имена ниже.
...
// Старое свойство keyCode объекта события keydown не стандартизировано.
...
Keymap.keyCodeToKeyName = {
    ...
    // Буквенные клавиши. Тут нет различия между символами верхнего и нижнего регистра
    65: "A", 66: "B",67: "C", 68: "D", 69: "E", 70: "F", 71: "G", 72: "H", 73: "I",
    74: "J", 75: "K", 76: "L", 77: "M", 78: "N", 79: "O", 80: "P", 81: "Q", 82: "R",
    83: "S", 84: "T", 85: "U", 86: "V", 87: "W", 88: "X", 89: "Y", 90: "Z",

    // Цифровые клавиши на дополнительной клавиатуре и клавиши со знаками препинания,
    // (не пожжерживаются в Opera)
