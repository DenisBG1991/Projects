...
var editor, statusline, savedutton, idletimer;
...
window.onload = function () {
    ...
    savedutton = document.getElementById("savebutton");

    editor.value = localStorage.note;       // Восстановить сохраненную заметку
    editor.disabled = true;                 // Но запретить редактирование до синхронизации
...
window.applicationCache.onupdateready = function () {
    status("Доступная новая версия приложения. " + "Чтобы использовать ее, неоходимо перезагрузить приложение ");
};
    ...
    if (navigator.onLine) {
        ...
        xhr.onload = function () {
            ...
            if (remoteModTime > localStorage.lastModified){
                ...
                "заметки. Щелкните по кнопке Ok, чтобы\n" +
                "использовать эту версию, или по кнопке\n" +
