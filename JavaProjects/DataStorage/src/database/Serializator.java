...
public class Serializator {
    public boolean serialization(Users ds, String fileName){
        boolean flag = false;
    ...
    public Users deserialization(String fileName) throws InvalidObjectException{
        File fr = new File(fileName);
        ObjectInputStream istream = null;
        try {
            FileInputStream fis =new FileInputStream(fr);
            istream = new ObjectInputStream(fis);
            Users st = (Users) istream.readObject();
            return st;
        ...
        throw new InvalidObjectException("объект не востановлен");
    }
}
